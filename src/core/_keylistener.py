...
"""
# Note:
# Runtime checkpoint / resume is handled by engine.py and higher-level callers.
# EscListener remains focused on immediate turn abort and should not interpret
# checkpoint text or token budget state.
